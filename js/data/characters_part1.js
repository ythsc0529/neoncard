...
const CHARACTERS_PART1 = [
    ...
    { id: 13, name: '迪斯查', rarity: 'EPIC', hp: 1, atk: 50, skills: [{ name: '免疫', desc: '免疫兩次傷害', cd: 10, effect: { type: 'immunity', hits: 2 } }], passive: null },
    ...
    { id: 22, name: '蘇賽德', rarity: 'COMMON', hp: 30, atk: 1, skills: [{ name: '全員玉碎', desc: '造成30攻擊並使自己死亡', cd: 2, effect: { type: 'damage_suicide', damage: 30 } }], passive: null },
    ...
    { id: 25, name: '護理師', rarity: 'RARE', hp: 200, atk: 30, skills: [{ name: '自我恢復', desc: '恢復50點生命值', cd: 4, effect: { type: 'heal', value: 50 } }, { name: '砍一刀', desc: '造成10點傷害', cd: 1, effect: { type: 'damage', value: 10 } }], passive: null },
    { id: 26, name: '超級坦克', rarity: 'MYTHIC', hp: 700, atk: 5, skills: [{ name: '裝甲', desc: '增加50血量上限', cd: 0, effect: { type: 'buff_max_hp', value: 50 } }, { name: '致命一擊', desc: '造成50%最大生命值傷害', cd: 8, effect: { type: 'damage_self_max_hp_percent', value: 50 } }], passive: null },
    ...
    { id: 35, name: '廚師', rarity: 'RARE', hp: 150, atk: 25, skills: [{ name: '吃我的食物啦', desc: '造成(食物×攻擊力)點傷害', cd: 3, effect: { type: 'damage_resource_mult', resource: 'food' } }, { name: '煮', desc: '煮一個食物', cd: 0, effect: { type: 'add_resource', resource: 'food', value: 1 } }], passive: null, resources: { food: 0 } },
    ...
    { id: 38, name: '瘋狗騎士', rarity: 'EPIC', hp: 500, atk: 5, skills: [{ name: '還沒倒下', desc: '恢復15%最大生命值', cd: 1, effect: { type: 'heal_max_hp_percent', value: 15 } }, { name: '絕殺', desc: '造成最大生命值×80%點傷害', cd: 12, effect: { type: 'damage_self_max_hp_percent', value: 80 } }], passive: { name: '疊加', desc: '每受到一次攻擊，增加10點最大生命值', effect: { trigger: 'on_hit', action: 'buff_max_hp', value: 10 } } },
    ...
    { id: 42, name: '籃球', rarity: 'COMMON', hp: 1, atk: 1, skills: [{ name: '投籃', desc: '有5%的機會將庫裡面加入卡組', cd: 0, effect: { type: 'summon_chance', chance: 5, target: '庫裡面' } }], passive: { name: '滑', desc: '10%的機率迴避所有傷害', effect: { trigger: 'on_hit', action: 'dodge_chance', chance: 10 } } },
