...
const RankedSystem = (() => {
    ...
    const TITLES = {
        ...
        '失柳煎啾':   { img: 'hao_pic/失柳煎啾.png',   color: '#00ccff', desc: '試煉之路等級 7 獎勵' },
        '真理學徒':   { img: 'hao_pic/真理學徒.png',   color: '#9900ff', desc: '試煉之路等級 10 獎勵' },
        '12了!':      { img: 'hao_pic/12了!.png',      color: '#ffdd00', desc: '試煉之路等級 12 獎勵' },
        '萬人斬':     { img: 'hao_pic/萬人斬.png',     color: '#ff2200', desc: '試煉之路等級 24 獎勵' },
        '染血的權杖': { img: 'hao_pic/染血的權杖.png', color: '#aa0000', desc: '試煉之路等級 25 獎勵' },
        '偽神':       { img: 'hao_pic/偽神.png',       color: '#777777', desc: '試煉之路等級 50 獎勵' },
        '造物主':     { img: 'hao_pic/造物主.png',     color: '#ffffff', desc: '試煉之路等級 100 獎勵' },
        '踢飛起步':   { img: 'hao_pic/踢飛起步.png',   color: '#00ffcc', desc: '通行證等級 20 獎勵' },
        '一腳定江山': { img: 'hao_pic/一腳定江山.png', color: '#ff7700', desc: '通行證進階軌道等級 19 獎勵' },
        '踢飛你':     { img: 'hao_pic/踢飛你.png',     color: '#ff0055', desc: '本賽季通行證獲取' },
        '排位沒難度': { img: 'hao_pic/排位沒難度.png', color: '#ffd700', desc: '完成排位賽 10 連勝新手任務' },
        '阿公67':     { img: 'hao_pic/阿公67.png',     color: '#00ffaa', desc: '組合包-阿共67!! 獲取' },
        '門清一摸三': { img: 'hao_pic/門清一摸三.png', color: '#00ff44', desc: '組合包-麻將組合包 獲取' },
        '太陽與地球': { img: 'hao_pic/太陽與地球.png', color: '#ffff00', desc: '組合包-太陽與地球 獲取' },
        '我是你爸':   { img: 'hao_pic/我是你爸.png',   color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '你搞笑?':    { img: 'hao_pic/你搞笑?.png',    color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '你講真':     { img: 'hao_pic/你講真.png',     color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '算你雖':     { img: 'hao_pic/算你雖.png',     color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '哈味':       { img: 'hao_pic/哈味.png',       color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '香菇怎麼叫': { img: 'hao_pic/香菇怎麼叫.png', color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '穿山甲欸':   { img: 'hao_pic/穿山甲欸.png',   color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '不要你離開': { img: 'hao_pic/不要你離開.png', color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '逼逼喇不':   { img: 'hao_pic/逼逼喇不.png',   color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '母雞抖':     { img: 'hao_pic/母雞抖.png',     color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '棒棒棒棒':   { img: 'hao_pic/棒棒棒棒.png',   color: '#ffffff', desc: '獎池：皇民化運動 獲取' },
        '我的豆花':   { img: 'hao_pic/我的豆花.png',   color: '#ffffff', desc: '獎池：皇民化運動 獲取' }
    };
